"""Entry point for the packaged Set Agent workbench (PyInstaller).
  ...
  SetAgentTimeline.exe                  open the workbench (WebView2)
  SetAgentTimeline.exe --playlist acid  open a specific playlist
  SetAgentTimeline.exe --classic        the old tkinter canvas, as a fallback
  SetAgentTimeline.exe --doctor         environment check (shown in a dialog too)
